...
run_sql "INSERT OR REPLACE INTO sessions (name, tmux_target, pid, broadcast_cursor, status, registered_at, last_seen) VALUES ('${SAFE_NAME}', ${TMUX_TARGET}, NULL, '${NOW}', 'idle', '${REGISTERED_AT}', '${NOW}');"
